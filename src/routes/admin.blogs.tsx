  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        action={
          <Button onClick={() => setEditing({ title: "", content: "", status: "draft", author: "Payitragam Team" })}>
      ...
      {items.length === 0 ? (
        <Card><p className="text-muted-foreground text-sm">No blog posts yet.</p></Card>
      ) : (
      ...
      <Modal
        ...
        footer={<>
          ...
          <Button onClick={() => (document.getElementById("blog-form") as HTMLFormElement)?.requestSubmit()}>
