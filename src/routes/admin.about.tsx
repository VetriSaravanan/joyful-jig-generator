  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <FormBlock onSubmit={save}>
        <Card>
          <Field label="Who We Are" value={data.who_we_are_text} onChange={(v) => set("who_we_are_text", v)} textarea rows={5} />
        </Card>
        <Card>
          <Field label="Mission" value={data.mission} onChange={(v) => set("mission", v)} textarea rows={3} />
        </Card>
        <Card>
          <Field label="Vision" value={data.vision} onChange={(v) => set("vision", v)} textarea rows={3} />
        </Card>
